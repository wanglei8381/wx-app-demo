 ...
 * @param {function(seed:*):{value:*, seed:*, done:boolean}|Promise<{value:*, seed:*, done:boolean}>} f unfolding
 *   function accepts a seed and returns a new tuple with a value, new seed, and boolean done flag. If tuple.done is
 *   true, the stream will end.
